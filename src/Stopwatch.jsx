...
const Separator = () => {
  return <Form.Label className='Stopwatch-number'>:</Form.Label>;
}
      ...
      <div className='Stopwatch'>
          <Form className='Stopwatch-display'>
            <FormGroup bsSize='large' controlId='formStopwatch'>
              <Form.Label className='Stopwatch-number'>{this.leadingZero(this.getHours())}</Form.Label>
              <Separator />
              <Form.Label className='Stopwatch-number'>{this.leadingZero(this.getMinutes())}</Form.Label>
              <Separator />
              <Form.Label className='Stopwatch-number'>{this.leadingZero(this.getSeconds())}</Form.Label>
            </FormGroup>
            <FormGroup>
              {buttons}
            </FormGroup>
